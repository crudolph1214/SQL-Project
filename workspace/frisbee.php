...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <img class="" src="img/dog_barn_frisbee.png" alt="Frisbee">
                </div>
            <div class="col-sm">
                    <h5 class="">Frisbee</h5>
                    <p>$1</p>
                    This frisbee is top dollar stuff. Its made out of plastic and its just a frisbee, but it supports us and is as fun as any other frisbee
                    <form action="addFrisebee.php" method="get">
