...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <img class="" src="img/dog_barn_bucket_hat.png" alt="Bucket Hat">
                </div>
            <div class="col-sm">
                <h5 class="">Bucket Hat</h5>
                <p>$5</p>
                This bucket har is top dollar stuff. Its made out of denim and just a bucket hat, but it supports us and is as cool as any other bucket hat.
                <form action="addHat.php" method="get">
